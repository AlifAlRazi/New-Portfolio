    ...
    <section id="about" className="py-24 px-4 relative">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          {/* ToggleITAI Company Card — Full GIF Background */}
          <motion.div
            className="glass-card overflow-hidden flex flex-col justify-between group border-violet-500/40 relative p-6 min-h-[240px]"
            variants={itemVariants}
          >
            {/* Full Card Background Animated GIF */}
            <Image
              src="/images/tia.gif"
              alt="ToggleITAI"
              fill
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/95 via-slate-950/70 to-slate-950/40 z-10" />

            {/* Top Pin & Badge */}
            <div className="relative z-20 flex justify-between items-start">
              <div className="p-2.5 rounded-xl bg-violet-600/90 backdrop-blur-md text-white shadow-lg shadow-violet-500/30">
                <Rocket size={20} />
              </div>
              <span className="text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-white/10 backdrop-blur-md text-violet-300 border border-violet-500/30">
                AI Venture
              </span>
            </div>
            ...
            <div className="relative z-20 mt-6">
              ...
              <h4 className="text-2xl font-black text-white drop-shadow-md mb-1.5">
                ToggleITAI
              </h4>
              ...
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-xs font-bold text-violet-400 hover:text-violet-300 hover:underline transition-colors"
              >
